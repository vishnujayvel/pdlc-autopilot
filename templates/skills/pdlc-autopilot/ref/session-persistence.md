...
## Artifact Provenance (SpecGate — MANDATORY)
...
## Kiro Validation Provenance (SpecGate — MANDATORY)
| Validation | Invoked Via | Result | Timestamp |
|-----------|-------------|--------|-----------|
| kiro:validate-gap | Skill tool | [warnings / clean] | [ISO] |
| kiro:validate-design | Skill tool | [GO / NO-GO] | [ISO] |
...
## Batch Status (CriticGate — ALL columns MANDATORY)
| Batch | Status | Tests After | ADVOCATE | SKEPTIC |
|-------|--------|-------------|----------|---------|
| A | DONE+CRITICS | 62 | PASS | PASS |
| B | DONE+CRITICS | 112 | PASS | PASS_WARN |
| C | ACTOR_DONE | 156 | pending | pending |
| D | PENDING | - | - | - |

**CriticGate:** A batch with Status="DONE" but blank ADVOCATE/SKEPTIC is a violation.
