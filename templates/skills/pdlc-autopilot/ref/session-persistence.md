...
## Artifact Provenance (PROC-1 — MANDATORY)
...
## Kiro Validation Provenance (PROC-1 — MANDATORY)
...
## Batch Status (PROC-2 — ALL columns MANDATORY)
...
**PROC-2:** A batch with Status="DONE" but blank ADVOCATE/SKEPTIC is a violation.
